...
export default class TypeBuilder {
    ...
    CalculatorTool: ClassViewer<'CalculatorTool', "operation" | "numbers">;
    
    MultiArgResponse: ClassViewer<'MultiArgResponse', "greeting" | "description" | "age_category">;
    
    ProfileResponse: ClassViewer<'ProfileResponse', "bio" | "interests" | "location">;
    
    Reply: ClassViewer<'Reply', "content" | "confidence">;
    
    WeatherTool: ClassViewer<'WeatherTool', "city" | "units">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "CalculatorTool","MultiArgResponse","ProfileResponse","Reply","WeatherTool",
          ]),
          enums: new Set([
        ...
        this.CalculatorTool = this.tb.classViewer("CalculatorTool", [
          "operation","numbers",
        ]);
        
        this.MultiArgResponse = this.tb.classViewer("MultiArgResponse", [
          "greeting","description","age_category",
        ]);
        
        this.ProfileResponse = this.tb.classViewer("ProfileResponse", [
        ...
        this.WeatherTool = this.tb.classViewer("WeatherTool", [
          "city","units",
        ]);
